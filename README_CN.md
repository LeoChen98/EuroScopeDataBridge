...
详细的 API 文档请参阅 [docs/wiki_CN.md](docs/wiki_CN.md)（中文）或 [docs/wiki.md](docs/wiki.md)（English）。面向 AI agent 的 API skill：[docs/API_REFERENCE_SKILL.md](docs/API_REFERENCE_SKILL.md)。
...
使用的第三方组件及其许可证见 [THIRD_PARTY_NOTICES.md](THIRD_PARTY_NOTICES.md)。
